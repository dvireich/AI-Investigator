...
import { Plus, Trash2, GripVertical, ChevronDown, ChevronUp, ChevronLeft, ChevronRight, Settings, X, RotateCcw, AlertTriangle, FileText, Code, Cpu, HelpCircle, Eye, Search, Library } from 'lucide-react';
import type { AgentDefinition, PipelineStage, PipelineDefinition, PipelinePreset } from '../types/pipeline';
import { stageProducesFinalReport } from '../types/pipeline';
import type { SavedAgent } from '../api';
import { api } from '../api';
import { AgentModal, pickColor } from './AgentModal';

// AgentModal lives in ./AgentModal.tsx so the same editor can be reused
// from the workflow palette here and from the Agents tab in Settings.
// Re-export for any external importer that referenced it from this module.
